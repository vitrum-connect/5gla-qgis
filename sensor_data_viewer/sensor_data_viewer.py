...
class SensorDataViewer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'SensorDataViewer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&5gLa sensor data viewer')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/sensor_data_viewer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'View Sensor Data'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            self.first_start = False
            self.dlg = SensorDataViewerDialog()
